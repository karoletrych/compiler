...
let processStatement 
    ...
    | Ast.VariableDeclaration(id, t, expr) 
        -> TypeInferenceAst.VariableDeclaration(id, t, (Some (TypeInferenceAst.expr expr t)))
    | Ast.ValueDeclaration(id, typ, expr) 
        -> TypeInferenceAst.ValueDeclaration(id, typ, TypeInferenceAst.exprWithType expr typ)
